...
Use the prerecorded walkthrough (see Sprint 3 / Sprint 4 tasks) or Scenario 3-only path if only the API fails. For a **~5 minute capture checklist**, use `docs/backup_video_recording_guide.md`.

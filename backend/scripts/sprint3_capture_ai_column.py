...
Deterministic column can be refreshed with GEMINI_API_KEY unset and no Vertex project.
...
# Ensure imports resolve when run as `python scripts/sprint3_capture_ai_column.py`
